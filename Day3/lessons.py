# lesson 1 of Day 3(Concatenate Lesson)
myName=input("What is your name? ")
myLunch=input("What are you having for lunch? ")
print(myName, "is going to be chowing down on",myLunch, "very soon!")

# the concatenate v2 inroduction
number=input("Give me a number: ")
group=input("Give me a collective noun of a group of things: ")
thing=input("Give me the name of a weird or wacky thing: ")
print("Noi don't think that",number,"is a",group,"of",thing,". That's just odd.")

# lesson 2 the common errors
yourName=input("Name: ")
whatYear=input("What year is it?: ")
print(yourName,"think it is ",whatYear)

# lesson 3 Fix my code
